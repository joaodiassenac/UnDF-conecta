    ...
    <v-app-bar flat color="white" border="b">
      <div class="d-flex align-center px-6 w-100 justify-space-between">
        <div class="d-flex align-center">
          <v-icon color="#0F2A4A" class="mr-2" size="18">mdi-square</v-icon>
          <span class="font-weight-bold text-h6 text-blue-grey-darken-4">Open Campus</span>
          <span class="text-caption text-grey-darken-1 ml-2">| Avaliação Institucional</span>
        </div>

        <v-sheet class="d-flex align-center px-4 py-2 bg-white rounded-lg elevation-1 border">
          <span class="text-body-2 font-weight-medium text-grey-darken-4 mr-2">Ana Silva Santos</span>
          <v-icon color="#0F2A4A" size="22">mdi-account-circle</v-icon>
        </v-sheet>
      </div>
    </v-app-bar>
    <v-main class="w-100">
